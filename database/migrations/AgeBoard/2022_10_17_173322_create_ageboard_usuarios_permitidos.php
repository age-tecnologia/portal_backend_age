...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ageboard_usuarios_permitidos', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('user_id');
            $table->unsignedBigInteger('funcao_id');
            $table->unsignedBigInteger('setor_id');
            $table->unsignedBigInteger('nivel_acesso_id');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('ageboard_usuarios_permitidos');
    }
};
