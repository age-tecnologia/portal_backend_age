...
class RvSupervisorController extends Controller
{
    ...
    public function cancelD7() : int
    {
        ...
        $sales = VoalleSales::select('id',
            ...
            ->where('supervisor', $this->username)
            ->get();
    ...
    public function sales() : int
    {
        ...
        $this->sales = VoalleSales::where('supervisor', $this->username)
            ->whereMonth('data_vigencia', $this->month)
            ->whereYear('data_vigencia', $this->year)
    ...
    {
        // Trás a contagem de todas as vendas realizadas no mês filtrado.
        $this->salesTotals = VoalleSales::where('supervisor', $this->username)
            ->whereMonth('data_vigencia', $this->month)
            ->whereYear('data_vigencia', $this->year)
            ->whereMonth('data_ativacao', $this->month)
            ->whereYear('data_ativacao', $this->year)
    ...
    {
        // Trás a contagem de todas as vendas realizadas no mês filtrado.
        $this->salesAprovation = VoalleSales::where('supervisor', $this->username)
    ...
    {
        // Trás a contagem de todas as vendas realizadas no mês filtrado.
        $data = VoalleSales::where('supervisor', $this->username)
            ->whereMonth('data_vigencia', $this->month)
            ->whereYear('data_vigencia', $this->year)
            ->whereMonth('data_ativacao', $this->month)
            ->whereYear('data_ativacao', $this->year)
