...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql_usercontrol' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL_USER_CONTROL'),
            'host' => env('DB_HOST_USER_CONTROL', '127.0.0.1'),
            'port' => env('DB_PORT_USER_CONTROL', '3306'),
            'database' => env('DB_DATABASE_USER_CONTROL', 'forge'),
            'username' => env('DB_USERNAME_USER_CONTROL', 'forge'),
            'password' => env('DB_PASSWORD_USER_CONTROL', ''),
            'unix_socket' => env('DB_SOCKET_USER_CONTROL', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
